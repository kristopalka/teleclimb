...
public class CompetitionManagementController {
    ...
    public CompetitionWithParticipantsList getAllParticipants(@PathVariable Integer id) {
        return additionalService.getAllParticipants(id);
    }

    @ApiOperation(value = "Return CUSTOM OBJECT: competition and rounds list")
    @GetMapping("/{id}/rounds")
    public CompetitionWithRoundsList getAllRounds(@PathVariable Integer id) {
    ...
    public CompetitionWithRoundsList generateRounds(@PathVariable Integer id) {
